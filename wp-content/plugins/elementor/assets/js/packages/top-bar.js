...
__webpack_require__.d(__webpack_exports__, {
  ...
  "registerAction": function() { return /* reexport */ registerAction; },
  "registerLink": function() { return /* reexport */ registerLink; },
  "registerToggleAction": function() { return /* reexport */ registerToggleAction; }
});
...
// Menus
const LOCATION_MAIN_MENU_DEFAULT = 'editor/top-bar/main-menu/default';
const LOCATION_MAIN_MENU_EXITS = 'editor/top-bar/main-menu/exits';
const LOCATION_TOOLS_MENU_DEFAULT = 'editor/top-bar/tools/default';
const LOCATION_UTILITIES_MENU_DEFAULT = 'editor/top-bar/utilities/default';
...
;// CONCATENATED MODULE: ./packages/top-bar/src/locations/register-menu-item.tsx
...
function createRegisterMenuItemFor(component) {
  return (menuName, {
    group = 'default',
    name,
    overwrite,
    ...
    const location = menuNameMap[menuName][group];
    if (!location) {
      return;
    }
...
const registerLink = createRegisterMenuItemFor(Link);
const registerAction = createRegisterMenuItemFor(Action);
const registerToggleAction = createRegisterMenuItemFor(ToggleAction);
...
function MainMenuLocation() {
  const injectionsGroups = (0,external_UNSTABLE_elementorPackages_locations_namespaceObject.useInjectionsOf)([LOCATION_MAIN_MENU_DEFAULT, LOCATION_MAIN_MENU_EXITS]);
  ...
  }), injectionsGroups.filter(injections => injections.length).map((injections, index) => {
...
function ToolsMenuLocation() {
  const injections = (0,external_UNSTABLE_elementorPackages_locations_namespaceObject.useInjectionsOf)(LOCATION_TOOLS_MENU_DEFAULT);
  ...
  return /*#__PURE__*/external_React_namespaceObject.createElement(ToolbarMenu, null, toolbarInjections.map(({
    filler: Filler,
    id
  }) => /*#__PURE__*/external_React_namespaceObject.createElement(Filler, {
    key: id
  })), popoverInjections.length > 0 && /*#__PURE__*/external_React_namespaceObject.createElement(ToolbarMenuMore, {
...
function UtilitiesMenuLocation() {
  const injections = (0,external_UNSTABLE_elementorPackages_locations_namespaceObject.useInjectionsOf)(LOCATION_UTILITIES_MENU_DEFAULT);
  const toolbarInjections = injections.slice(0, utilities_menu_location_MAX_TOOLBAR_ACTIONS);
  const popoverInjections = injections.slice(utilities_menu_location_MAX_TOOLBAR_ACTIONS);
  return /*#__PURE__*/React.createElement(ToolbarMenu, null, toolbarInjections.map(({
    filler: Filler,
    id
  }, index) => /*#__PURE__*/React.createElement(external_React_namespaceObject.Fragment, {
    key: id
    ...
    orientation: "vertical"
  }), /*#__PURE__*/React.createElement(Filler, null))), popoverInjections.length > 0 && /*#__PURE__*/React.createElement(ToolbarMenuMore, {
